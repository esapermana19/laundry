...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-0 md:p-6 font-sans overflow-x-hidden">
    ...
    <div
        class="w-full max-w-[1080px] h-screen md:h-[520px] bg-white md:rounded-[2.5rem] md:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.15)] overflow-hidden relative flex flex-col md:flex-row">

        <!-- ================= BACKGROUND GAMBAR FULL (Sisi Kanan) ================= -->
        <div class="absolute inset-0 z-0 w-full h-full">
            <img src="{{ asset('assets/bg3.jpg') }}" alt="KlinWash Laundry Illustration"
                class="w-full h-full object-cover object-center" onerror="this.src='pexels-equalstock-31251590.jpg';" />
        ...
        <div
            class="w-full lg:w-[100%] md:w-[100%] bg-white md:bg-white/95 lg:bg-white h-full flex flex-col justify-between p-8 sm:p-12 md:p-16 z-10 angled-left-panel relative">
                ...
                <div class="p-2 bg-brand rounded-lg text-white shadow-md shadow-brand/20">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                            d="M3 12c0-3.3 2.7-6 6-6h.1c1.4 0 2.7.5 3.8 1.4L15 9.5c1.1.9 2.4 1.4 3.8 1.4H19c3.3 0 6 2.7 6 6s-2.7 6-6 6h-.1c-1.4 0-2.7-.5-3.8-1.4L13 19.5c-1.1-.9-2.4-1.4-3.8-1.4H9c-3.3 0-6-2.7-6-6z"
                            opacity="0.3"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                            d="M3 12c0-1.65 1.35-3 3-3h.1c.7 0 1.35.25 1.9.7l1.1.85c1.1.9 2.4 1.4 3.8 1.4H15c1.65 0 3 1.35 3 3s-1.35 3-3 3h-.1c-.7 0-1.35-.25-1.9-.7l-1.1-.85c-1.1-.9-2.4-1.4-3.8-1.4H6c-1.65 0-3-1.35-3-3z">
                        </path>
                    </svg>
                </div>
            ...
            <div class="my-auto max-w-[360px] w-full pt-8 pb-6 md:py-0">
                ...
                <div
                    class="p-3 mb-6 text-xs rounded-xl flex items-center justify-between <?= $messageType === 'success' ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-red-50 text-red-700 border border-red-200' ?>">
                    <span class="font-semibold"><?= $loginMessage ?></span>
                    <button onclick="this.parentElement.style.display='none'"
                        class="font-bold ml-2 text-lg hover:opacity-75 focus:outline-none">&times;</button>
                </div>
                <?php endif; ?>
                ...
                <form action="{{ route('proseslogin') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        <label for="email"
                            class="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2 ml-1">
                            Email address
                        </label>
                        <input type="text" id="email" name="email" placeholder="username@jacusa.com"
        ...
        <div
            class="hidden md:flex md:absolute md:right-12 lg:right-24 md:top-1/2 md:-translate-y-1/2 z-20 flex-col items-center justify-center text-center">

            <!-- Logo Ikon KlinWash Putih (Meniru gaya Spark) -->
            <div
                class="mb-4 p-5 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 shadow-2xl animate-pulse">
